...
require '../constants/uniques.php';
	...
	$message = "Hellow!! <b>$full_name</b>, <br>Click <a href='$actual_link'>HERE</a> to reset your <b>IMS - LVCC</b> password.";   
    ...
    $mail->isSMTP();                                      
    $mail->Host = "smtp://smtp.mailtrap.io:2525";
    $mail->SMTPAuth = true;                           
    $mail->Username = "38686aa2ae6a3c:38da21191ec348";
    $mail->Password = $smtp_pass;                          
    $mail->SMTPSecure = 'tls';                            
    $mail->Port = 587;                                   

    $mail->setFrom($smtp_user, 'lvims@no-reply');
