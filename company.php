						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="company-detail-wrapper">
								...
								<div class="company-detail-header text-center">
									...
									<p class="location"><i class="fa fa-map-marker"></i> <?php echo "$compzip"; ?>
										<?php echo "$compcity"; ?>. <?php echo "$compstreet"; ?>,
										<?php echo "$compcountry"; ?> <span class="mh-5">|</span> <i
											class="fa fa-phone"></i> <?php echo "$compphone"; ?></p>
									...
									<ul class="meta-list clearfix">
										...
										<li>
											...
											<a target="_blank"
												href="https://<?php echo "$compweb"; ?>"><?php echo "$compweb"; ?></a>
										</li>
									</ul>
												...
												<div class="row">
													...
													<div class="col-sm-7 col-md-8">
														...
														<div class="meta-div clearfix mb-25">
															<span>at <a
																	href="company.php?ref=<?php echo "$company_id"; ?>"><?php echo "$compname"; ?></a></span>
															<?php echo "$sta"; ?>
														</div>
		                        ...
		                        ?><li class="paging-nav"><a
												...
												href="company.php?ref=<?php echo "$company_id"; ?>&page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a>
										</li><?php
                                 }	
