						...
						<div class="col-sm-5 col-md-4">
							...
							<div class="company-detail-sidebar">
								...
								<h2 class="heading mb-15">
									...
									<p class="location"><i class="fa fa-map-marker"></i> <?php echo "$zip"; ?>
										<?php echo "$city"; ?>. <?php echo "$street"; ?>, <?php echo "$country"; ?>
										<span class="block"> <i class="fa fa-phone"></i>
											<?php echo "$myphone"; ?></span></p>
									...
									<ul class="meta-list clearfix">
										...
										<li>
											...
											<a target="_blank"
												href="https://<?php echo "$myweb"; ?>"><?php echo "$myweb"; ?></a>
										</li>
										<li>
									...
									<a href="./" class="btn btn-primary mt-5"><i
						...
						<div class="col-sm-7 col-md-8">
							...
							<div class="company-detail-wrapper">
								...
								<div class="company-detail-company-overview  mt-0 clearfix">
									...
									<form class="post-form-wrapper" action="app/update-job.php" method="POST"
										autocomplete="off">
										...
										<div class="row gap-20">
											...
											<div class="col-sm-8 col-md-8">
												...
												<div class="form-group">
													...
													<input name="title" value="<?php echo "$jobtitle"; ?>" required
											...
											<div class="col-sm-4 col-md-4">
												...
												<div class="form-group">
													<label>City</label>
													<input name="city" value="<?php echo "$jobcity"; ?>" required
												...
												<div class="form-group">
													...
													<select name="country" required
														...
														<?php
                                                           ...
                                                           {
		                                                    ?> <option
															<?php if ($jobcountry == $row['country_name']) { print ' selected '; } ?>
												...
												<div class="form-group">
													...
													<select name="category" required
														...
														<?php
                                                           ...
                                                           {
		                                                    ?> <option
															<?php if ($jobcategory == $row['category']) { print ' selected '; } ?>
											...
											<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
												...
												<div class="form-group mb-20">
													...
													<select name="jobtype" required
														...
														<option
															<?php if ($jobtype == "Full-time") { print ' selected '; } ?>
															value="Full-time"
															data-content="<span class='label label-warning'>Full-time</span>">
															Full-time</option>
														<option
															<?php if ($jobtype == "Part-time") { print ' selected '; } ?>
															value="Part-time"
															data-content="<span class='label label-danger'>Part-time</span>">
															Part-time</option>
														<option
															<?php if ($jobtype == "Freelance") { print ' selected '; } ?>
															value="Freelance"
											...
											<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
												...
												<div class="form-group mb-20">
													...
													<select name="experience" required
														...
														<option
															<?php if ($experience == "2 Years") { print ' selected '; } ?>
															value="2 Years">2 Years</option>
														<option
															<?php if ($experience == "3 Years") { print ' selected '; } ?>
															value="3 Years">3 Years</option>
														<option
															<?php if ($experience == "4 Years") { print ' selected '; } ?>
															value="4 Years">4 Years</option>
														<option
															<?php if ($experience == "5 Years") { print ' selected '; } ?>
											...
											<div class="col-sm-12 col-md-12">
												...
												<div class="form-group bootstrap3-wysihtml5-wrapper">
													...
													<textarea class="form-control bootstrap3-wysihtml5"
														name="description" required placeholder="Enter description ..."
														style="height: 200px;"><?php echo "$jobdescription"; ?></textarea>
												</div>
											...
											<div class="col-sm-12 col-md-12">
												...
												<div class="form-group bootstrap3-wysihtml5-wrapper">
													...
													<textarea name="responsiblities" required
														class="form-control bootstrap3-wysihtml5"
														placeholder="Enter responsiblities..."
														style="height: 200px;"><?php echo "$jobrespo"; ?></textarea>
												</div>
											...
											<div class="col-sm-12 col-md-12">
												...
												<div class="form-group bootstrap3-wysihtml5-wrapper">
													...
													<textarea name="requirements" required
														...
														style="height: 200px;"><?php echo "$jobreq"; ?></textarea>
												</div>
