				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../job-list.php" style="text-transform:capitalize;">Programs</a>
							...
							<li>
								<a
									href="https://docs.google.com/document/d/1COZVBqXLOQW9DXWsH3aj5vQX_ENodz3H/edit?fbclid=IwAR0TK3tohSsZLD5H1RiNZq9iWqxOsVwHwEczj9WjdweTfLVXMQnVVkah_t8"
									style="text-transform:capitalize;">Evaluation
									form</a>
							</li>
							<li>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="../company.php?ref=<?php echo "$myid"; ?>"><i
													class="fa fa-briefcase"></i> Company Overview</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST"
										autocomplete="off">
										...
										<div class="row gap-20">
											...
											<div class="col-sm-12 col-md-8">
												...
												<div class="form-group">
													...
													<input name="company" placeholder="Enter company name" type="text"
														class="form-control" value="<?php echo "$compname"; ?>"
														required>
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input name="year" placeholder="Enter year eg: 2016, 2017, 2018"
														type="text" class="form-control" value="<?php echo "$esta"; ?>"
														required>
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input class="form-control" placeholder="Eg: Booking, Travel"
														...
														value="<?php echo "$mytitle"; ?>" required>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-md-4">
													...
													<select name="people" required
														...
														<option
															<?php if ($mypeople == "1-10") { print ' selected '; } ?>
															value="1-10">1-10</option>
														<option
															<?php if ($mypeople == "11-100") { print ' selected '; } ?>
															value="11-100">11-100</option>
														<option
															<?php if ($mypeople == "200+") { print ' selected '; } ?>
															value="200+">200+</option>
														<option
															<?php if ($mypeople == "300+") { print ' selected '; } ?>
															value="300+">300+</option>
														<option
															<?php if ($mypeople == "1000+") { print ' selected '; } ?>value="1000+">
															1000+ </option>
													</select>
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input name="city" required type="text" class="form-control"
														value="<?php echo "$city"; ?>" placeholder="Enter your city">
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input name="zip" required type="text" class="form-control"
														value="<?php echo "$zip"; ?>" placeholder="Enter your zip">
												</div>
												...
												<div class="form-group">
													...
													<select name="country" required
														...
														<?php
                                                           ...
                                                           {
		                                                    ?> <option
															<?php if ($country == $row['country_name']) { print ' selected '; } ?>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<input type="email" name="email" required class="form-control"
														value="<?php echo "$mymail"; ?>" placeholder="Enter your email">
												</div>
											...
											<div class="col-sm-12 col-md-12">
												...
												<div class="form-group bootstrap3-wysihtml5-wrapper">
													...
													<textarea name="services" class="bootstrap3-wysihtml5 form-control"
														placeholder="Enter company services ..."
														style="height: 200px;"><?php echo "$myserv"; ?></textarea>
												</div>
											...
											<div class="col-sm-12 col-md-12">
												...
												<div class="form-group bootstrap3-wysihtml5-wrapper">
													...
													<textarea name="expertise" class="bootstrap3-wysihtml5 form-control"
														placeholder="Enter company expertise ..."
														style="height: 200px;"><?php echo "$myex"; ?></textarea>
												</div>
									...
									<form action="app/new-dp.php" method="POST" enctype="multipart/form-data">
										...
										?><a onclick="return confirm('Are you sure you want to delete your logo ?')"
													class="btn btn-primary btn-inverse"
													href="app/drop-dp.php">Delete</a> <?php
										}
										?>
											</div>
										</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p align="justify">LVIMS is an internship portal for the BSIS 4th year students of La Verdad Christian
												College, Apalit
												Pampanga. his is entrusted to our obligation to consult with our school administration and clients in
												terms of understanding various data needs and restructuring our delivery of services to effectively
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="../">Home</a></li>
											<li><a href="../job-list.php">Programs</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : McArthur Highway 2009 Apalit, Philippines</p>
								<p>Email : <a href="mailto:info@laverdad.edu.ph">info@laverdad.edu.ph</a></p>
								<p>Phone : <a href="tel:(045) 436 1487">(045) 436 1487</a></p>
