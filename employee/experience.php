								...
								?>
									...
									<div id="QualifModal" class="modal fade login-box-wrapper" tabindex="-1"
										...
										<div class="modal-body">
											...
											<form action="app/add-experience.php" method="POST" autocomplete="off"
												...
												<div class="row gap-20">
													...
													<div class="col-sm-6 col-md-6">
														...
														<div class="form-group">
															...
															<input class="form-control" placeholder="Eg: 01 March 2017"
													...
													<div class="col-sm-6 col-md-6">
														...
														<div class="form-group">
															...
															<input class="form-control" placeholder="Eg: 01 June 2017"
																type="date" name="enddate" required>
														</div>
