						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
                                    ...
                                    foreach($result as $row)
                                    {
									 ...
									 ?>
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a target="_blank"
															href="view-certificate.php?id=<?php echo $row['id']; ?>">
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a href="app/drop-qualification.php?id=<?php echo $row['id']; ?>"
														...
														<div id="edit<?php echo $row['id']; ?>"
															...
															<div class="modal-body">
																<form action="app/update-professional-qualification.php"
                                        ...
                                        ?>
																					...
																					<option
																						<?php if ($ccountry == $row['country_name'] ) { print ' selected '; } ?>
		                        ...
		                        ?><li class="paging-nav"><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>
														href="qualifications.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a>
												</li><?php
                                 }	
								...
								?>
									...
									<div id="QualifModal" class="modal fade login-box-wrapper" tabindex="-1"
										...
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"
												aria-hidden="true">&times;</button>
											<h4 class="modal-title text-center">Add Educational Attainment</h4>
										</div>

										<div class="modal-body">
											<form action="app/add-professional-qualification.php" method="POST"
