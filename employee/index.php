...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
		...
		<?php
																 $myedu = 'Bachelor of Science';
																 $mytitle = 'Information Systems';
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST"
										...
										<div class="row gap-20">
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<div class="col-xs-5 col-sm-5">
														<select name="month" required class="selectpicker form-control"
															data-live-search="false">
															<option value=" " selected disabled>- Select a Month -
															</option>
											...
											<div class="form-group">
												...
												<div class="col-sm-6 col-md-4">
													<input value="<?php echo "$myedu"; ?>" name="education" type="text"
														required class="form-control" disabled>
												</div>

												<div class="col-sm-6 col-md-4">
													<input value="<?php echo "$mytitle"; ?>" name="title" required
														type="text" class="form-control mb-15" disabled>
												</div>
											...
											<div class="col-sm-6 col-md-4">
												...
												<div class="form-group">
													...
													<select name="gender" required
														...
														<option
															<?php if ($mygender == "Male") { print ' selected '; } ?>
															value="Male">Male</option>
														<option
															<?php if ($mygender == "Female") { print ' selected '; } ?>value="Female">
															Female</option>
													</select>
												</div>
												...
												<div class="form-group">
													...
													<input name="street" required type="text" class="form-control"
														value="<?php echo "$mystreet"; ?>">
																						...
																						<div class="clear"></div>
																																	...
																																	<div class="col-sm-6 col-md-4">
																																		...
																																		<div class="form-group">
																																			...
																																			<label>Region</label>
																																			<select name="country" required class="selectpicker show-tick form-control"
                                                           ...
                                                           {
		                                                    ?> <option
																																					<?php if ($mycountry == $row['country_name']) { print ' selected '; } ?>
											...
											<div class="col-sm-12 col-md-12">
												...
												<div class="form-group bootstrap3-wysihtml5-wrapper">
													...
													<textarea name="about" class="bootstrap3-wysihtml5 form-control"
