						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a>
															...
															<div class="image">
																<center><img src="../images/default.jpg" alt="image"
															...
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	...
																	<i class="fa fa-user text-primary mr-5"></i>
																	<?php echo "$reftitle"; ?>.
																</div>
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a href="app/drop-ref.php?id=<?php echo $row['id']; ?>"
														...
														<div id="edit<?php echo $row['id']; ?>"
															...
															<div class="modal-body">
																<form action="app/update-ref.php" method="POST"
		                        ...
		                        ?><li class="paging-nav"><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>
														href="referees.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a>
												</li><?php
                                 }	
								...
								?>
									...
									<div id="QualifModal" class="modal fade login-box-wrapper" tabindex="-1"
										...
										<div class="modal-body">
											...
											<form action="app/add-referee.php" method="POST" autocomplete="off"
												...
												<div class="row gap-20">
													...
													<div class="col-sm-6 col-md-6">
														...
														<div class="form-group">
															<label>Referee Name</label>
															<input class="form-control" placeholder="Enter referee name"
																type="text" name="name" required>
														</div>
													...
													<div class="col-sm-12 col-md-6">
														...
														<div class="form-group">
															<label>Referee Email</label>
															<input class="form-control"
																placeholder="Enter referee email" type="email"
																name="email" required>
														</div>
													...
													<div class="col-sm-12 col-md-6">
														...
														<div class="form-group">
															<label>Referee Title</label>
															<input class="form-control"
																placeholder="Enter referee title" type="text"
																name="title" required>
														</div>
													...
													<div class="col-sm-12 col-md-6">
														...
														<div class="form-group">
															<label>Referee Phone</label>
															<input class="form-control"
																placeholder="Enter referee phone" type="text"
																name="phone" required>
														</div>
