						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a <?php if ($certificate == "") { }else{ ?> target="_blank"
															href="view-certificate-b.php?id=<?php echo $row['id']; ?> <?php } ?>">
															...
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i
																		class="fa fa-building text-primary mr-5"></i><strong
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a href="app/drop-training.php?id=<?php echo $row['id']; ?>"
														...
														<div id="edit<?php echo $row['id']; ?>"
															...
															<div class="modal-header">
																...
																<h4 class="modal-title text-center">
																	<?php echo "Training and Workshop"; ?></h4>
															</div>

															<div class="modal-body">
																<form action="app/update-training.php" method="POST"
																		...
																		<div class="col-sm-12 col-md-12">
																			...
																			<div class="form-group">
																				...
																				<input class="form-control date-picker"
																					...
																					id="date-picker" type="text"
																					name="daterange timeframe" required>
																			</div>
		                        ...
		                        ?><li class="paging-nav"><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>
														href="training.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a>
												</li><?php
                                 }	
								...
								?>
									...
									<div id="QualifModal" class="modal fade login-box-wrapper" tabindex="-1"
										...
										<div class="modal-body">
											<form action="app/add-training.php" method="POST" autocomplete="off"
												...
												<div class="row gap-20">
													...
													<div class="col-sm-12 col-md-12">
														...
														<div class="form-group">
															<label>Training Name</label>
															<input class="form-control"
																placeholder="Enter training name" type="text"
													...
													<div class="col-sm-12 col-md-12">
														...
														<div class="form-group">
															<label>Time Frame</label>
															<input class="form-control date-picker" id="date-picker"
																placeholder=" " type="text" name="daterange timeframe"
																required>
														</div>
