...
try {
	...
	$sta = '<span class="label label-success">Internship</span>';
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<div class="meta-div clearfix mb-25">
										<span>at <a target="_blank"
												href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a>
											as </span>
										<?php echo "$sta"; ?>
									</div>
						        ...
						        if ($user_online == true) {
								if ($jobexpired == true) {
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-calendar"></i> This Offer is expired</button>';
								}else{
								if ($myrole == "employee") {
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login as an Intern to apply</button>';
								}	
								}
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login to apply this Offer</button>';	
								}
