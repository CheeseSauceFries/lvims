							...
							<div class="row">
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										...
										<?php
										 ...
										 $cat = $row['category'];
                                        ?>
										<option <?php if ($slc_category == "$cat") { print ' selected '; } ?>
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										...
										<option <?php if ($slc_country == "$cnt") { print ' selected '; } ?>
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								if ($type == "Internship") {
								$sta = '<span class="job-label label label-success">Internship</span>';
													...
													<div class="col-sm-5 col-md-4">
														<ul class="meta-list">
															...
															<!-- <li>
																<span>Deadline: </span>
																<?php echo "$post_month"; ?>
																<?php echo "$post_date"; ?>, <?php echo "$post_year"; ?>
															</li> -->
														</ul>
													</div>
		                        ...
		                        ?><li class="paging-nav"><a
												<?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>
												href="job-list.php?page=<?php echo "$b"; ?><?php if ($fromsearch == true) { print '&category='.$cate.'&country='.$country.'&search=✓'; }?>"><?php echo $b." "; ?></a>
										</li>
										<?php
                                 }	
