					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
									<h5>Address</h5>
									<address> McArthur Highway 2009 <br /> Apalit, <br /> Philippines</address>
								</li>
								<li>
									<h5>Email</h5><a href="mailto:info@laverdad.edu.ph">info@laverdad.edu.ph</a>
								</li>
								<li>
									<h5>Phone Number</h5><a href="tel:(045) 436 1487">(045) 436 1487</a>
								</li>
								...
								<li>
									...
									<div class="contact-social">
										...
										<a href="<?php echo "$fb"; ?>" data-toggle="tooltip" data-placement="top"
											title="Facebook"><i class="fa fa-facebook"></i></a>
										<a href="<?php echo "$tw"; ?>" data-toggle="tooltip" data-placement="top"
											title="Twitter"><i class="fa fa-twitter"></i></a>
										<a href="<?php echo "$ig"; ?>" data-toggle="tooltip" data-placement="top"
